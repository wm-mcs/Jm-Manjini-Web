...
class Noticia extends Model
{
    ...
    public function getContenidoRenderAttribute()
    {
        ...
        $cadena = str_replace('(YOU)' ,'<span class="post-video" > <iframe  src="https://www.youtube.com/embed/', $cadena);
        $cadena = str_replace('(/YOU)' ,'" frameborder="0" allowfullscreen="allowfullscreen"></iframe></span>', $cadena);
